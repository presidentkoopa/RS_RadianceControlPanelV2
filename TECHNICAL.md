...
**Status:** the texture-scanned emitter layer — walls, floors, ceilings and
things, each with a sound, a light and particles — was removed for a stretch
of this project's history for being more maintenance than it was worth, then
restored. Two systems the original scan carried, `gitd_voice` (four preset
dialects) and the klaxon riding the sector sweep, were deliberately left out
of that restoration and are not currently part of this build.
